<template>
  <div class="app-container">
    ...
    <el-form
      ...
      @submit.prevent
    >
      <el-form-item label="商品类型名称" prop="className" :label-width="100">
        <el-input
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="skuClassRef" :model="form" :rules="rules" label-width="80px" @submit.prevent>
...
function handleDelete(row) {
  ...
  proxy.$modal
    .confirm('是否确认删除商品类型编号为"' + _classIds + '"的数据项？')
    .then(function () {
