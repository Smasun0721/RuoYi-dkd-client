  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="vmRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="设备类型" prop="vmTypeId" v-else-if="form.id != null">
          <div v-for="item in vmTypeList" :key="item.id">
        ...
        <el-form-item label="设备容量" prop="channelMaxCapacity" v-if="form.id != null">
        ...
        <el-form-item label="设备地址" prop="addr" v-if="form.id != null">
          <span>{{ form.addr }}</span>
        </el-form-item>
      </el-form>
