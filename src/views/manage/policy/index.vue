<template>
  <div class="app-container">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['manage:policy:query']"
            >查看详情</el-button
          >
          <el-button
            link
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="policyRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="策略方案" prop="discount">
          <el-input v-model="form.discount" placeholder="请输入策略方案" />
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <el-dialog :title="title" v-model="viewOpen" width="500px" append-to-body>
      <el-form ref="policyRef" :model="viewForm" label-width="80px">
        <el-form-item label="策略名称:" prop="policyName">
          {{ form.policyName }}
        </el-form-item>
        <el-form-item label="包含设备:" prop="discount" />
        <div>
          <el-table v-loading="loading" :data="viewForm">
            <el-table-column label="序号" align="center" type="index" width="50" />
...
const data = reactive({
  ...
  rules: {
    ...
    discount: [{ required: true, message: "策略方案，如：80代表8折不能为空", trigger: "blur" }],
  },
});
