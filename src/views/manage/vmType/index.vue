...
const data = reactive({
  ...
  rules: {
    ...
    vmRow: [{ required: true, message: "货道行不能为空", trigger: "blur" }],
    vmCol: [{ required: true, message: "货道列不能为空", trigger: "blur" }],
    channelMaxCapacity: [{ required: true, message: "设备容量不能为空", trigger: "blur" }],
  },
});
